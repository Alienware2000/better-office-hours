...
export function buildGrokMessages(
  ...
  const system = `${loadTutorPrompt("your course")}\n\n${context}${extra}${boardNote}${BOARD_NARRATION}${voice}${eventBlock}${materialNote}${describeBoard(board)}${TEACHING_GUIDANCE}${lane}`;
